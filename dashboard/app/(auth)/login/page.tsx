...
export default function LoginPage() {
  ...
  function inputStyle(field: string): React.CSSProperties {
    ...
    return {
      ...
      border: `1px solid ${active ? "rgba(139,92,246,0.45)" : "rgba(255,255,255,0.09)"}`,
      color: "var(--color-foreground)",
      paddingLeft: "2.5rem",
      paddingRight: field === "password" ? "2.5rem" : "1rem",
      boxShadow: active ? "0 0 0 3px rgba(139,92,246,0.12)" : "none",
    ...
    <div className="relative min-h-screen flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          <div
            ...
            style={{
              ...
              boxShadow: "0 0 40px rgba(139,92,246,0.25), 0 0 16px rgba(139,92,246,0.15) inset",
              transition: "transform 0.3s ease",
            }}
          >
            <Zap className="w-7 h-7" style={{ color: "#c4b5fd" }} strokeWidth={2.5} />
          </div>
          <h1 className="text-2xl font-bold gradient-text tracking-tight">LLM Gateway</h1>
        ...
        <div
          ...
          style={{
            boxShadow: "0 0 40px rgba(139,92,246,0.15), 0 0 0 1px rgba(139,92,246,0.12) inset, 0 24px 64px rgba(0,0,0,0.5)",
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <Mail
                  ...
                  style={{ color: focused === "email" ? "#a78bfa" : "var(--color-muted-foreground)", transition: "color 0.2s" }}
                />
                <input
                  type="email"
                  required
            ...
            <div>
              ...
              <div className="relative">
                <Lock
                  className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none"
                  style={{ color: focused === "password" ? "#a78bfa" : "var(--color-muted-foreground)", transition: "color 0.2s" }}
                />
                <input
