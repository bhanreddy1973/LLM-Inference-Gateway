  ...
  return (
    <div className="relative flex-1">
      <button
        ...
        onClick={onClick}
        disabled={loading}
        className="group flex h-11 w-full items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.03] text-sm font-medium text-zinc-300 transition-all hover:border-white/20 hover:bg-white/[0.06] hover:text-zinc-50 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50"
      >
...
export default function RegisterPage() {
  ...
  async function handleGitHubSignup() {
    ...
    try {
      ...
      if (err instanceof ApiError) {
        ...
        setError("GitHub signup is not available right now.");
      }
      setOauthLoading(null);
    }
  }
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#09090b]">
      ...
      <div
        className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.02)_1px,transparent_1px),linear_gradient(to_bottom,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[length:64px_64px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,black_20%,transparent_100%)]"
        aria-hidden="true"
      />
      <div
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2 text-center">
            ...
            <p className="text-sm text-zinc-500">
              Start managing your AI infrastructure in minutes
            </p>
          </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              {password.length > 0 && (
                <div className="mt-1.5 flex flex-col gap-2">
                  ...
                  <p className="text-[11px] text-zinc-500">{passwordStrength.label}</p>
                </div>
              )}
            </div>
          ...
          {/* Features */}
          <div className="flex flex-col gap-2.5 rounded-xl border border-white/[0.06] bg-white/[0.02] p-4">
          ...
          <p className="text-center text-sm text-zinc-500">
            ...
            <Link href="/login" className="font-medium text-zinc-300 transition hover:text-white">
              Sign in
            </Link>
          </p>
        </div>
