...
class InferenceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamInfer = channel.unary_stream(
                ...
                request_serializer=inference__pb2.InferenceRequest.SerializeToString,
                response_deserializer=inference__pb2.StreamChunk.FromString,
                _registered_method=True)
...
def add_InferenceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'StreamInfer': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=inference__pb2.InferenceRequest.FromString,
                    response_serializer=inference__pb2.StreamChunk.SerializeToString,
            ),
...
class InferenceService(object):
    ...
    def StreamInfer(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            '/inference.InferenceService/StreamInfer',
            inference__pb2.InferenceRequest.SerializeToString,
            inference__pb2.StreamChunk.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
